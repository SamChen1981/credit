    ...
    <article class="table_top mar_left_right sub_ContainerHeight">
        ...
        <section>
            ...
            <div class="displayInline ver_top">
                ...
                <div class="select ver_middle m_right">
                    <ul style="display:none;" id="searchType">
                        <li value="1">用户名</li>
                        <li value="2">手机</li>
                    </ul>
                    <input type="hidden" name="sort" value="">
            ...
            <table class="table_list">
                ...
                <?php foreach($ProductLogs as $k=>$ProductLog){?>
                 <tr>
                        ...
                        <td>
                            <?php echo $ProductLog['ExchangeLog']['ProductStatus'] ;?>
                        </td>
                        <td>
                            <?php echo $ProductLog['ExchangeLog']['product_name'] ;?>
                        </td>
                        <td>
                             <?php echo $ProductLog['ExchangeLog']['status'] ;?>
                        </td>
                         <td>
                        ...
                        <td>
                            ...
                            <?php if($ProductLog['ExchangeLog']['status']=="未兑换" &&  $ProductLog['ExchangeLog']['is_overtime']==""){?>
                                <a href="javascript:void(0)" class="btv_ico ico_duihuan" title="兑换"  onclick="exchange(<?php echo $ProductLog['ExchangeLog']['id'] ;?>)"></a>
                            <?php }?>
                        </td>
                 </tr>
                <?php } ?>
 ...
 <script>
      ...
      //改变搜索状态
       ...
       //导出
             ...
             var data1={};
              ...
              data1['id']="<?php echo $ProductLog['ExchangeLog']['product_id'];?>";
              data1["form"]=1;
               $.ajax({
                  ...
                  //小于1000
                      if(data.message==1){
                        window.location.href="<?php echo $this->Html->url('/ExchangeLogs/ShowFromProduct');?>?export=1&"+data.data;
                      }
                  //大于1000
                          ...
                          var dChange = dialog({
                                  ...
                                  cancelValue:'取消',
                                  ok : function(){
                                      var url="<?php echo $this->Html->url('/ExchangeLogs/ShowFromProduct');?>?export=1&"
    ...
    var return1=function(){
     window.location.href="<?php echo $this->Html->url("/ExchangeLogs/SearchByProduct/1/").$aname;?>";
    }
    //查看商品兑换详情
        ...
        var sreach=function(){
             var param = "";
             var url = "<?php echo $this->Html->url('/ExchangeLogs/ShowFromProduct');?>?id=<?php echo $id;?>";
             $(".search-item").each(function(){
                       if($(this).attr('value') != ''){
