...
if(!defined('NMC_INTERFACE_URL')) define('NMC_INTERFACE_URL', 'http://www.net.cc/interface/');
...
if(!defined('APPKEY')) define('APPKEY','12345687');
if(!defined('APPSECRET')) define('APPSECRET','6c440400aa32ceb21f38447f0923ceadaed8cbc0');
