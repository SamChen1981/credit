 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs22guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '768593096527453542496749683645');
...
Cache::config('_cake_config_', array(
	'engine' => $engine,
	'prefix' => $prefix . 'cake_config_',
	'path' => CACHE . 'config' . DS,
	'serialize' => ($engine === 'File'),
	'duration' => '+1 days'
));
