...
//  		$sh=Session::get('share','');
		...
		$Tokenas = sha1($encryptStr);
	   	...
	   	$hostre="http://".$this->tid.".mp-vip.sobeycloud.com/WeChatMatrixs/getJSsdkInfo/?SourceToken=$Tokenas&TenantID=".$this->tid."&WeChatID=".$this->wid."&Timestamp=$tt";
	        var_dump($hostre);
